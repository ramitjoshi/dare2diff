...
function AddPiece()
{
	...
	$sql="insert into job_piece_component (job_id,piece_id,component,thick,length,width,cubic_sq,cubic_sq_int,water,weight,cost,ab_val,total_weight,total_cost,tot_abs_vol,csa_per,fume_per,cr_date,status) values ('".$job_id."','".$piece_id."','".$recipe."','".$thick."','".$length."','".$width."','".$cubic_sq_ft."','".$cubic_sq_ft_int."','".$water."','".$json_weight."','".$json_cost."','".$json_ab_val."','".$total_weight."','".$total_cost."','".$total_ab_val."','".$csa_per."','".$silica_fume_per."','".$cr_date."','1')";   
	$statement = $db->prepare($sql);   	      
	$statement->execute();    
	echo $piece_id;   
...
function EditPieceComp()
{
	...
	$sql="update job_piece_component set weight='".$json_weight."',cost='".$json_cost."',ab_val='".$json_ab_val."',total_weight='".$total_weight."',total_cost='".$total_cost."',tot_abs_vol='".$total_ab_val."',water='".$water."',csa_per='".$csa_per."',fume_per='".$silica_fume."' where id='".$pc_comp_id."'"; 
	$statement = $db->prepare($sql);   	    
	$statement->execute();   
...
function AddPieceComp() 
{
	...
	$sql="insert into job_piece_component (job_id,piece_id,component,thick,length,width,cubic_sq,cubic_sq_int,weight,cost,ab_val,total_weight,total_cost,tot_abs_vol,cr_date,status) values ('".$job_id."','".$piece_id."','".$recipe."','".$thick."','".$length."','".$width."','".$cubic_sq_ft."','".$cubic_sq_ft_int."','".$json_weight."','".$json_cost."','".$json_ab_val."','".$total_weight."','".$total_cost."','".$total_ab_val."','".$cr_date."','1')";   
	$statement = $db->prepare($sql);   	    
	$statement->execute();    
