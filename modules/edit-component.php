					...
					$per_json=get_job_components_info($pc_comp_id,'percentage'); 
					...
					<a class="cust-del pull-right delete_cust" id="1" u="aaaaaaaa bbbbbbb" href="javascript:void(0)" onclick="delete_comp('<?php echo $pc_comp_id; ?>');"> <i class="fa fa-trash-o"></i></a>
                            ...
                            <table>
                                <thead>
									...
									<tr>
                                        ...
                                        <th style="width: 29%;"><input type="text" name="height" onkeyup="cal_cubic_fig();" value="<?php echo get_job_components_info($pc_comp_id,'length'); ?>" disabled></th> 
                                ...
                                <tbody>
									...
									foreach($result_1 as $row_1)
									{
										...
										<tr class="inner-tab">
											...
											<td>
												<div class="weight_value">
													<input type="text" class="weight_txt input_<?php echo $row_1['id']; ?>" u="1" name="portland_concrete" onkeyup="cal_a(<?php echo $row_1['id']; ?>);"value="<?php echo $ArrayWeight[0]; ?>">   
											...
											<td>
												<div class="input_cost">
													<span class="dollar">$</span><span class="total_cost cost_<?php echo $row_1['id']; ?> cost_portland_concrete"><?php echo $Arraycost[0]; ?></span> 
													<input type="text" name="tot_cost[]" class="cost_text_box_<?php echo $row_1['id']; ?>" value="0" style="display:none;">
												</div>
											</td>
											<td>
												<div class="input_cost">
													<span class="sg_cal_<?php echo $row_1['id']; ?> tot_sg_cal ab_portland_concrete"><?php echo $Arrayab_val[0]; ?></span>
									...
									<tr> 
                                        ...
                                        <td> 
                                           <div class="weight_value asd_value " tabindex="<?php echo $i; ?>">
												...
												?>
													<input class="input_<?php echo $row['id']; ?> weight_txt" name="<?php echo $class_name; ?>_weight" type="text" u="<?php echo $row['id']; ?>" value="<?php echo $ArrayWeight[1]; ?>" readonly> 
												...
												{	
												?>
													<input class="input_<?php echo $row['id']; ?> weight_txt <?php echo $class_name; ?>" name="tot_weight[]" type="text" onkeyup="cal_cost('<?php echo $row['id']; ?>');" u="<?php echo $row['id']; ?>" value="<?php echo $ArrayWeight[1]; ?>">  
												<?php
												}
												?>
												...
												<span class="def_<?php echo $class_name; ?>" style="display:none;"><?php echo $Arrayper[0]; ?></span>    
											...
											<?php
												if (in_array($row['id'], $arr)) { 
												?>
													<input class="<?php echo $class_name; ?> percent_txt" type="text" u="<?php echo $row['id']; ?>" name="<?php echo $class_name; ?>_per" value="<?php echo $Arrayper[0]; ?>">  
                                        ...
                                        <td>
                                            <div class="input_cost"> 
												<span class="dollar">$</span><span class="total_cost cost_<?php echo $row['id']; ?>"><?php echo $Arraycost[1]; ?></span>
												<input type="text" name="tot_cost[]" class="cost_text_box_<?php echo $row['id']; ?>" value="<?php echo $Arraycost[1]; ?>" style="display:none;"> 
											</div> 
                                        </td>
										<td>
										<div class="input_cost">
										<span class="sg_cal_<?php echo $row['id']; ?> tot_sg_cal"><?php echo $Arrayab_val[1]; ?></span>
									...
									<tr> 
                                        ...
                                        <td> 
                                           <div class="weight_value asd_value " tabindex="<?php echo $i; ?>">
												...
												if (in_array($row['id'], $arr)) { 
												?>
													<input class="input_<?php echo $row['id']; ?> weight_txt" name="<?php echo $class_name; ?>_weight" type="text" u="<?php echo $row['id']; ?>" value="<?php echo $ArrayWeight[2]; ?>" readonly>  
													<span class="side_value">lb</span>	 
												...
												{	
												?>
													<input class="input_<?php echo $row['id']; ?> weight_txt <?php echo $class_name; ?>" name="tot_weight[]" type="text" onkeyup="cal_cost('<?php echo $row['id']; ?>');" u="<?php echo $row['id']; ?>" value="<?php echo $ArrayWeight[2]; ?>"> 
												<?php
												}
												?>
												...
												<span class="def_price_<?php echo $row['id']; ?>" style="display:none;"><?php echo $price; ?></span> 
												<span class="def_input_<?php echo $row['id']; ?>" style="display:none;"><?php echo $price; ?></span>  
												<span class="def_<?php echo $class_name; ?>" style="display:none;"><?php echo $Arrayper[1]; ?></span>  
											...
											<?php
												if (in_array($row['id'], $arr)) { 
												?>
													<input class="<?php echo $class_name; ?> percent_txt" type="text" u="<?php echo $row['id']; ?>" name="<?php echo $class_name; ?>_per" value="<?php echo $Arrayper[1]; ?>"> 
													<span class="side_value">%</span>
												<?php 
												}  
												?>
                                        ...
                                        <td> 
                                            <div class="input_cost"> 
												<span class="dollar">$</span><span class="total_cost cost_<?php echo $row['id']; ?>"><?php echo $Arraycost[2]; ?></span>
												<input type="text" name="tot_cost[]" class="cost_text_box_<?php echo $row['id']; ?>" value="<?php echo $Arraycost[2]; ?>" style="display:none;"> 
											</div>   
                                        </td>
										<td>
										<div class="input_cost">
										<span class="sg_cal_<?php echo $row['id']; ?> tot_sg_cal"><?php echo $Arrayab_val[2]; ?></span>
										<span class="main_cat_<?php echo $row['id']; ?>" style="display:none;"><?php echo $sg; ?></span> 
										</div> 
										</td>
									</tr>
									...
									foreach($result_1 as $row_1)
									{
										...
										<tr class="inner-tab"> 
											...
											<td>
												<div class="weight_value">
													<input type="text" class="weight_txt input_<?php echo $row_1['id']; ?>" u="2" name="sand" value="<?php echo $ArrayWeight[3]; ?>"  readonly>
													<span class="cost_txt price_<?php echo $row_1['id']; ?> price_sand " style="display:none;"><?php echo $row_1['price']; ?></span>  
													<span class="def_sand" style="display:none;"><?php echo $ArrayWeight[3]; ?></span>  
													<span class="def_input_<?php echo $row_1['id']; ?>" style="display:none;"><?php echo $ArrayWeight[3]; ?></span> 
												</div>   
												<div class="weight_text">
												   <?php echo $row_1['weight']; ?>
												</div> 
											...
											<td>
												<div class="input_cost">
													<span class="dollar">$</span><span class="total_cost cost_<?php echo $row_1['id']; ?> cost_sand"><?php echo $Arraycost[3]; ?></span>
													<input type="text" name="tot_cost[]" class="cost_text_box_<?php echo $row_1['id']; ?>" value="<?php echo $Arraycost[3]; ?>" style="display:none;">
												</div>
											</td>
											<td>
												<div class="input_cost">
													<span class="sg_cal_<?php echo $row_1['id']; ?> tot_sg_cal ab_sand"><?php echo $Arrayab_val[3]; ?></span> 
									...
									<tr>
                                        ...
                                        <td>
                                            <div class="weight_value asd_value weight_pigments" tabindex="2">
												<input class="weight_txt input_<?php echo $row_1['id']; ?>" type="text" name="water_weight" u="<?php echo $row_1['id']; ?>" value="<?php echo $ArrayWeight[4]; ?>" readonly >  
												<span class="side_value">lb</span>
												...
												<span class="def_input_<?php echo $row_1['id']; ?>" style="display:none;"><?php echo $row_1['price']; ?><?php echo $Arrayper[2]; ?></span> 
												  
												
											</div>
											<div class="weight_text">
                                              
											   <input type="text" class="percent_txt"  value="<?php echo $Arrayper[2]; ?>" name="water" onkeyup="cal_water();"> 
												<span class="def_water" style="display:none;"><?php echo $Arrayper[2]; ?></span>
												<span class="side_value">%</span>
                                            </div>
										</td> 
                                        <td>
											<div class="input_cost">
												<span class="dollar">$</span><span class="total_cost cost_<?php echo $row_1['id']; ?>"><?php echo $Arraycost[4]; ?></span>
												<input type="text" name="tot_cost[]" class="cost_text_box_<?php echo $row_1['id']; ?>" value="<?php echo $Arraycost[4]; ?>" style="display:none;">
											</div> 
										</td>
										<td>
										<div class="input_cost">
											<span class="sg_cal_<?php echo $row_1['id']; ?> tot_sg_cal"><?php echo $Arrayab_val[4]; ?></span> 
									...
									*/
									...
									foreach($result_1 as $row_1)
									{
										...
										<tr class="inner-tab"> 
											...
											<td>
												<div class="weight_value">
													<input type="text" class="weight_txt input_<?php echo $row_1['id']; ?>" onkeyup="cal_cost('<?php echo $row_1['id']; ?>');" u="4" name="sealer" value="<?php echo $ArrayWeight[5]; ?>">   
													<span class="cost_txt price_<?php echo $row_1['id']; ?>" style="display:none;"><?php echo $row_1['price']; ?></span> 
													<span class="def_sealer" style="display:none;"><?php echo $ArrayWeight[5]; ?></span>
													<span class="def_input_<?php echo $row_1['id']; ?>" style="display:none;"><?php echo $row_1['price']; ?></span>   		
												</div>    
												<div class="weight_text">
												   <?php echo $row_1['weight']; ?>
											...
											<td>
												<div class="input_cost">
													<span class="dollar">$</span><span class="total_cost cost_<?php echo $row_1['id']; ?>"><?php echo $Arraycost[5]; ?></span>
													<input type="text" name="tot_cost[]" class="cost_text_box_<?php echo $row_1['id']; ?>" value="<?php echo $Arraycost[5]; ?>" style="display:none;">
												</div> 
											</td>
											<td> 
												<div class="input_cost">
													<span class="sg_cal_<?php echo $row_1['id']; ?> tot_sg_cal"><?php echo $Arrayab_val[5]; ?></span>
									...
									<tr> 
                                        ...
                                        <td> 
                                           <div class="weight_value asd_value " tabindex="<?php echo $i; ?>">
												...
												if (in_array($row['id'], $arr)) { 
												?>
													<input class="input_<?php echo $row['id']; ?> weight_txt" name="<?php echo $class_name; ?>_weight" type="text" u="<?php echo $row['id']; ?>" value="<?php echo $ArrayWeight[$a]; ?>" readonly> 
													<span class="side_value">lb</span>	 
												...
												{	
												?>
													<input class="input_<?php echo $row['id']; ?> weight_txt <?php echo $class_name; ?>" name="tot_weight[]" type="text"  u="<?php echo $row['id']; ?>" value="<?php echo $ArrayWeight[$a]; ?>"  readonly> 
												<?php
												}
												?>  
												...
												<span class="def_price_<?php echo $row['id']; ?>" style="display:none;"><?php echo $price; ?></span> 
												<span class="def_input_<?php echo $row['id']; ?>" style="display:none;"><?php echo $price; ?></span>  
												<span class="def_<?php echo $class_name; ?>" style="display:none;"><?php echo $Arrayper[$b]; ?></span>   
												 
											</div>    
											<div class="weight_text">
											
													<input class="<?php echo $class_name; ?> percent_txt" type="text" u="<?php echo $row['id']; ?>" name="<?php echo $class_name; ?>_per" onkeyup="cal_weight_cat('<?php echo $row['id']; ?>','<?php echo $class_name; ?>');" value="<?php echo $Arrayper[$b]; ?>">  
													<span class="side_value">%</span> 
                                        ...
                                        <td>
                                            <div class="input_cost"> 
												<span class="dollar">$</span><span class="total_cost cost_<?php echo $row['id']; ?>"><?php echo $Arraycost[$a]; ?></span>
												<input type="text" name="tot_cost[]" class="cost_text_box_<?php echo $row['id']; ?>" value="<?php echo $Arraycost[$a]; ?>" style="display:none;"> 
											</div> 
                                        </td>
										<td>
										<div class="input_cost">
										<span class="sg_cal_<?php echo $row['id']; ?> tot_sg_cal"><?php echo $Arrayab_val[$a]; ?></span>  
										<span class="main_cat_<?php echo $row['id']; ?>" style="display:none;"><?php echo $sg; ?></span> 
										</div> 
										</td>
									</tr>
                                    ...
                                    <tr>
										...
										foreach($Arrayper as $val)
										{
											$tot_per_str .=number_format($val, 2, '.', '').",";
											
										} 
										
										$tot_per_str=substr($tot_per_str,0,-1);
                                        ...
                                        <td colspan="4" align="center">
											...
											<input type="text" id="new_tot_weight" name="new_tot_weight" value="<?php echo $tot_weight_str; ?>"> 
											<input type="text" id="new_tot_cost" name="new_tot_cost" value="<?php echo $tot_cost_str; ?>">  
											<input type="text" id="new_tot_ab_val" name="new_tot_ab_val" value="<?php echo $tot_ab_val_str; ?>"> 
											<input type="text" id="new_tot_per" name="new_tot_per" value="<?php echo $tot_per_str; ?>"> 
											
											<input type="text" id="new_total_weight" name="new_total_weight" value="<?php echo $tot_weight; ?>"> 
											<input type="text" id="new_total_cost" name="new_total_cost" value="<?php echo $tot_cost; ?>"> 
											<input type="text" id="new_total_ab_val" name="new_total_ab_val" value="<?php echo $tot_ab_val; ?>">   
